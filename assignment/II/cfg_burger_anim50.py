...
def simulate(f, u, v, nx, ny, nozzle_u, nozzle_v, dx, dy, dt, nu, steps):
...
def evolve(param, initial_u, initial_v, nt):
    [nx, ny, nozzle_u, nozzle_v, dx, dy, dt, nu] = param
    return simulate(1, initial_u, initial_v, nx, ny, nozzle_u, nozzle_v, dx, dy, dt, nu, nt)
...
nt = 2510  # the number of steps we are simulating
...
(final_u, final_v) = evolve([nx, ny, nozzle_u, nozzle_v, dx, dy, dt, nu], initial_u, initial_v, nt)
